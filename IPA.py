...
beer_req = requests.get('https://www.beeradvocate.com/beer/top-rated/', headers=headers)
beer_req.raise_for_status()
beer = BeautifulSoup(beer_req.text, 'html.parser')

beer_links = beer.select('beer')
